...
RUN apt-get update \
 && apt-get -qq -y install libmemcached-dev ca-certificates netbase curl libpq5 libpq-dev libxml2 \
...
# Add dist folder with the binary and config
ADD dist /app/
