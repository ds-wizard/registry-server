...
serializeActionType ForgottenTokenActionKey = "ForgottenTokenActionKey"

serializeOrganizationRole :: OrganizationRole -> String
serializeOrganizationRole AdminRole = "AdminRole"
serializeOrganizationRole UserRole = "UserRole"
...
deserializeActionType mActionTypeS = do
  ...
  case actionType of
    ...
    "ForgottenTokenActionKey" -> Just ForgottenTokenActionKey

deserializeOrganizationRole :: Maybe String -> Maybe OrganizationRole
deserializeOrganizationRole mOrgRoleS = do
  orgRoleS <- mOrgRoleS
  case orgRoleS of
    "AdminRole" -> Just AdminRole
    "UserRole" -> Just UserRole
    _ -> Nothing
