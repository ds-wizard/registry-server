...
runPersistentCommands' = runPersistentCommands runAppContextWithAppContext' updateContext execute components

runPersistentCommandChannelListener' :: AppContextM ()
runPersistentCommandChannelListener' = runPersistentCommandChannelListener runAppContextWithAppContext' updateContext execute components
